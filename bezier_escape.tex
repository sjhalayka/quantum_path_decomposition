...
\begin{abstract}
By quantizing the kinematic and gravitational time dilation using various step sizes (e.g. wavelengths), one obtains a set of weighted orbit paths.
...
Here we report the precession angle $\delta_{p}$ in terms of arcseconds per Earth century.
There is a highly visible pattern. 
