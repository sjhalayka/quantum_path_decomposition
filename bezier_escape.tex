...
\end{tabular}
\end{center}
If we add bit counts 22, 23, and 24 together (e.g. $ +   +  $) we get $ $ arcseconds per Earth century.
...
\end{tabular}
\end{center}
If we add bit counts 21, 22, and 23 together, we get $ $.
...
\end{tabular}
\end{center}
If we add bit counts 23 and 24 together, we get $ $.
